                    ...
                    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <textarea name="content_ar" class="form-control editor-rich @error('content_ar') is-invalid @enderror" rows="8">{{ old('content_ar', $page->content_ar) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="content_en" class="form-control editor-rich @error('content_en') is-invalid @enderror" rows="8">{{ old('content_en', $page->content_en) }}</textarea>
