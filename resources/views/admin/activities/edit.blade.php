                    ...
                    <form action="{{ route('admin.activities.update', $activity->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <textarea name="description_ar" class="form-control editor-rich" rows="4">{{ old('description_ar', $activity->description_ar) }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold small">وصف (إنجليزي)</label>
                                <textarea name="description_en" class="form-control editor-rich" rows="4">{{ old('description_en', $activity->description_en) }}</textarea>
                            </div>
                        </div>
