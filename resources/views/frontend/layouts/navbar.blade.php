<nav class="site-navbar" id="siteNavbar">
    <div class="navbar-inner">
        ...
        <div class="d-none d-lg-flex align-items-center gap-2">
            <ul class="navbar-nav-wrap">
                ...
                <li class="nav-item-wrap has-mega-menu">
                    <a href="{{ route('services.index') }}" class="nav-link-item {{ request()->routeIs('services.*') ? 'active' : '' }}">
                        {{ __('خدماتنا') }}
                ...
                <li class="nav-item-wrap"><a href="{{ route('activities.index') }}" class="nav-link-item {{ request()->routeIs('activities.*') ? 'active' : '' }}">{{ __('الأنشطة') }}</a></li>
                <li class="nav-item-wrap"><a href="{{ route('about') }}" class="nav-link-item {{ request()->routeIs('about') ? 'active' : '' }}">{{ __('من نحن') }}</a></li>
            </ul>

            <div class="ms-3 d-flex align-items-center gap-3">
                <a href="{{ route('contact') }}" class="navbar-cta">{{ __('تواصل معنا') }}</a>
                {{-- Lang --}}
                <div class="dropdown">
                    <button class="nav-link-item border-0 bg-transparent px-3" data-bs-toggle="dropdown">
        ...
        {{-- Mobile Toggle --}}
        <button class="d-lg-none btn border-0 fs-3 p-0" id="mobileMenuToggle" style="color:var(--primary-dark);">
